...
| **Sync** | Request-Response | Payment Orchestrator → Vietcombank Acquirer | HTTPS REST, 30s timeout, 1 retry after 5s | — |
...
| Payment Orchestrator | Vietcombank Acquirer | HTTPS, 30s timeout + 1 retry | Sync |
...
| Vietcombank Acquirer | NAPAS Switch | ISO 8583 | Sync |
...
| Acquirer communication | Payment Orchestrator | HTTPS (mutual TLS if required by Vietcombank) |
