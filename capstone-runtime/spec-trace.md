...
| I-9 forbidden: Merchant Platform querying AcquirerHost | `merchant_platform.call_acquirer_directly(acquirer_host)` | `PermissionError` (no such Lab 9 relationship) | `I9ForbiddenPathTests.test_i9_merchant_platform_cannot_call_acquirer_directly` |
